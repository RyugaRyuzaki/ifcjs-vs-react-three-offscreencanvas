...
export class GeometryCullerRenderer extends CullerRenderer {
  ...
  set setupEvent(enabled: boolean) {
    ...
    if (enabled) {
      this.controls.addEventListener("rest", this.updateCulling);
      this.controls.addEventListener("controlstart", this.updateCulling);
      this.controls.addEventListener("controlend", this.updateCulling);
      this.controls.addEventListener("wake", this.updateCulling);
    } else {
      this.controls.removeEventListener("rest", this.updateCulling);
      this.controls.removeEventListener("controlstart", this.updateCulling);
      this.controls.removeEventListener("controlend", this.updateCulling);
      this.controls.removeEventListener("wake", this.updateCulling);
    }
  }
  private updateCulling = async () => {
  ...
  constructor(
    ...
    super(components, controls, settings);
